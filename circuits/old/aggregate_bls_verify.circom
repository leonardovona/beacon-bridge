...
include "../resources/circom-pairing/circuits/bls_signature.circom";
include "../resources/circom-pairing/circuits/curve.circom";
include "../resources/circom-pairing/circuits/bls12_381_func.circom";
