...
export function sigHexAsSnarkInput(
  ...
  if (returnType === "hex") {
    ...
    return [
      [
        bigint_to_array(55, 7, sig.toAffine()[0].c0.value),
        bigint_to_array(55, 7, sig.toAffine()[0].c1.value),
      ],
      [
        bigint_to_array(55, 7, sig.toAffine()[1].c0.value),
        bigint_to_array(55, 7, sig.toAffine()[1].c1.value),
      ],
    ];
  }
}
